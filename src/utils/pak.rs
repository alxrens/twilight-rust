...
pub async fn get_pak() -> String {
    let data : &[&str] = &[ "Fake technical support is one of my favorite things to do.",
    "Proof of Existence",
    ...
    "Nowhere is a place.",
    "Fomo [fōmō
    ] (noun) : A state of mental or emotional strain caused by the fear of missing out.",
    "Early until late.",
    ...
    "Numerous metaverses are being constructed. However,
    \"download and run\" is not an acceptable choice when it comes to #crypto spheres. Regardless of how lovely your world is, #security will always take precedence.  As a result, web-nativeize your metaverse(s).",
    ...
    "Ouch",
    "Oh what the",
    "The transformation will be from bigger to smaller.  So,
    25 cubes will give you \"Twenty Cubes\" + \"Five Cubes\" NFTs.  Not 25 x \"A Cube\" NFTs.",
    ...
    "At least,
    \"cats\" are out of my auto suggestions now.",
    ...
    "If you are learning 3d software and chasing beautiful results, learn more about light and photography.   Remember,
    3d software is only a tool that will help you experiment faster, virtually. Your theoretical knowledge still counts.",
    ...
    "Every work I've released so far had a conflict or a question, they tried to push one thing or another.  It may be technical, it may be social, or it may be directly related to the market itself or the way auctions work. It may be about anything.  But I believe,
    \"this is the way.\"",
    ...
    "The Meeting is only available for one day. When the time hits 6 November (PST) The Meeting will be over.  Highest bid will be accepted,
    ...
    "How about now?",
    "We should concentrate on making things* that make people think,
    \"I wish I did it first.\"",
    "It's a wonderful thing to appreciate someone else's work so much that it makes you think,
    \"I wish I did it first.\"  You could’ve done it.. You've had the opportunity to grasp the mind, but they've gotten there quicker.   Isn't that lovely?",
    ...
    "“Remaining exiles will be burned.” Book name,
    2020",
    "Goodbye Stigma!",
    "Goodbye Mute!",
    ...
    "◆",
    "♾️ The hidden piece,
    \"Rebirth of Narcissus\" (1/1) will be revealed and given to the collector of \"Death of Narcissus\".",
    ...
    "Specially when it's a \"community\" related cause, one always thinks,
    \"could this be handled better?\". I think so.",
    "☠️",
    "“Collection Closed”",
    ...
    "X plays with value.",
    "X has 15 pieces of concepts,
    13 of them are n/n editions and 2 of them are 1/1 singles.",
    ...
    "One of the Duplicates will be burned,
    5 Aug Wednesday 8PM CET. What hidden token will it unlock?",
    "🦄",
    ...
    "Watching films, I've always wondered,
    \"If the camera didn't look at it, would I?\" Would it be significant enough to make my head turn and force my eyes to focus? Or am I only looking because the camera tells me so?",
    ...
    "To find the real insider,
    \"the real collector\",
    \"the cream of the crop\", hashtags are eliminated. This way the discovery is more related to it's audience of influence and less related to it's human added point of view: curated meta tags.",
    ...
    "“The most interesting thing about the Tumblr acquisition is that everyone on Twitter apparently has more than [$3 million
    ] laying around.”",
    "So tumblr just got acquired for $3M. I wish I knew, I'd pay more.",
    "rip tumblr",
    "Once there was Ventilate[dot
    ]ca - what happened to it?",
    ...
    "Nowadays,
    \"video\" is the most static thing online. Sort of.",
    ...
    204863 was the only content that was designed (and not discovered) - and it should be taken as my way of showing this community my respect.",
    ...
    "[users
    ] What is your point of view on this comparison?",
    ...
    "Clean up, meaning: I'm removing words such as \"God\",
    \"Lord\",
    \"Allah\" from the texts as I don't want to disrespect any belief system.",
    ...
    "DIY No one will",
    "Machine + [things
    ] may be human. Human - [things
    ] can never be machine.  That's concerning.",
    ...
    "..99 little bugs in the code, fix one bug compile it again,
    ...
    let index = rand::thread_rng().gen_range(0..data_len);

    String::from(data[index])
}